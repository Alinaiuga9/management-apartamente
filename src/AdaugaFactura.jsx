    ...
    <div className="min-h-screen bg-gray-100 flex flex-col items-center pt-10">
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-lg border-t-4 border-green-500">
        ...
        <div className="mb-4">
          ...
          <input type="number" className="w-full border p-2 rounded focus:ring-2 focus:ring-green-500" />
        </div>
        <div className="mb-6">
          <label className="block text-gray-700 font-medium mb-2">Tip utilitate</label>
          <select className="w-full border p-2 rounded focus:ring-2 focus:ring-green-500">
        ...
        <div className="flex justify-between items-center mt-8">
          <Link to="/" className="text-green-600 font-medium">&larr; Înapoi</Link>
          <button onClick={() => alert("Factură emisă!")} className="px-6 py-2 bg-green-600 text-white rounded hover:bg-green-700">Emite</button>
        </div>
      </div>
    </div>
  );
